...
export class DateBuilder<Output extends Maybe<Properties['value']> = Properties['value']> extends GeneralOptionBuilder<Output, Properties> {
    constructor() {
    ...
    public nullable() {
        ...
        return this as DateBuilder<Nullable<Output>>
    }
    ...
    public required() {
        ...
        return this as unknown as DateBuilder<NonUndefinable<Output>>
    }
